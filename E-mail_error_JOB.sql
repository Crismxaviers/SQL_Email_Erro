...
ALTER PROC [dbo].[PRC_EMAIL_FALHA_JOB]  @getJobName VARCHAR(100)
...
SET @destination = 'E-MAIL DE DESTINO'
...
<table class="bigbox"
	<div class="imagem1">
         <img class="cabecalho"
             	...
             	src="\\CAMINHO DO BANNER\banner.png"
             	style="display: block;
            	height="200" border="0">
    </div>
    <div class="titulo">
	...
	<div class="mensagem">
      ...
      <div class="finalzinho">
           <span class="textend">EMPRESA | DIRETORIA </span>  
    	<div class="imagem2">
		         <img class="logodti"
		 			alt="Data" 
			 		src="\\CAMINHO\1000.png" 
                   >
    	</div>
       </div>
    <div class="rodape">
